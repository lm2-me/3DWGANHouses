...
#wgan v H is a gan using Wasserstein loss, logits, LeakyReLU, learning rate decay, and label smoothing
...
def make_generator_model(num_class=2):
    ...
    #! confirm this still works, was tanh
...
def train_gan(path, run_name, num_vox, max_load):
    ...
    train(path, run_name, train_dataset, EPOCHS, noise_dim, generator, discriminator, generator_optimizer, discriminator_optimizer, seed, manager, cross_entropy, acc_real, acc_fake, num_vox)
