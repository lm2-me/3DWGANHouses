...
#wgan v L is a gan using Wasserstein loss, logits, LeakyReLU, and learning rate decay, with batch normalization,, and using the Root Means Square Prop optimizer
