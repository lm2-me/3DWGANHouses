...
#16 has 10 layers channels 96-96-48-48-24-24-12-12-2-2
...
def train(path, run_name, dataset, epochs, noise_dim, generator, discriminator, generator_optimizer, discriminator_optimizer, seed, checkpoint_manager, acc_real, acc_fake, num_vox):
  ...
  for epoch in trange(epochs, desc='Epoch'):
    ...
    for image_batch in tqdm(dataset, desc='Iteration'):
      ...
      real_loss, per_vox_loss, fake_loss, real_acc, fake_acc, gradients_of_discriminator, gradient_penalty = util.train_discriminator(image_batch, noise_dim, generator, discriminator, acc_real, acc_fake, num_vox)
      ...
      util.print_loss_info(path, run_name, epoch, gen_per_vox_loss, real_loss, fake_loss, per_vox_loss, real_acc, fake_acc, check_result)
