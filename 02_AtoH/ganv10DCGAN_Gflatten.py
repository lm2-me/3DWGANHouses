...
#Gflatten uses logits, LeakyReLU in the generator and the critic, and uses learning rate decay
#Gflatten uses Tanh and a flatten layer at the end of the generator 
