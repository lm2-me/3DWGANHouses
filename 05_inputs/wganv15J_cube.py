...
#this architecture uses randomly generated cubes as an input for the generator instead of noise
...
def train(path, run_name, dataset, epochs, inputsize, generator, discriminator, generator_optimizer, discriminator_optimizer, seed, checkpoint_manager, acc_real, acc_fake, num_vox):
  ...
  for epoch in trange(epochs, desc='Epoch'):
    ...
    for image_batch in tqdm(dataset, desc='Iteration'):
      ...
      real_loss, disc_per_vox_loss, fake_loss, real_acc, fake_acc, gradients_of_discriminator, gradient_penalty = util.train_discriminator(image_batch, inputsize, generator, discriminator, acc_real, acc_fake, num_vox)
